...
const handleClickRecentLabel = function () {
  // console.log("recent");
  loadComponent("recentReview", "/components/reviewcard?query=recentrev", complete=setMaxPageReview);
  toggleLi("recentLi");
  setTimeout(function () {
...
const handleClickPopularLabel = function () {
  // console.log("popular");
  loadComponent("popularReview", "/components/reviewcard?query=popular", complete=setMaxPageReview);
  toggleLi("popularLi");
  setTimeout(function () {
...
const handleClickMostLabel = function () {
  ...
  loadComponent("mostReviewed", "/components/postercard?direction=horizontal&query=trendrev");
  toggleLi("mostLi");
  setTimeout(function () {
